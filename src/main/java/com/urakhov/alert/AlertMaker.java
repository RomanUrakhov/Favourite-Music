...
public class AlertMaker {
    ...
    public static void showMaterialDialog(StackPane root, Node nodeToBeBlurred, List<JFXButton> controls, String header, String body) {
        ...
        l1.getStyleClass().add("common-label");
        dialogLayout.setHeading(l1);
        Label l2 = new Label(body);
        l2.getStyleClass().add("common-label");
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/view/css/dark_theme.css").toExternalForm());
